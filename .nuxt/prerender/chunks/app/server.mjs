import { getCurrentInstance, inject, version, defineComponent, h, computed, unref, Suspense, nextTick, Transition, provide, reactive, ref, resolveComponent, shallowRef, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, withCtx, createVNode } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/unctx/dist/index.mjs';
import { hasProtocol, isEqual, parseURL, joinURL } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/ufo/dist/index.mjs';
import { createError as createError$1, sendRedirect } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/.pnpm/h3@1.0.1/node_modules/h3/dist/index.mjs';
import { useHead, createHead as createHead$1 } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/@unhead/vue/dist/index.mjs';
import { renderDOMHead, debouncedRenderDOMHead } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/@unhead/dom/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/vue-router/dist/vue-router.node.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderAttrs } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/.pnpm/defu@6.1.1/node_modules/defu/dist/defu.mjs';
...
const node_modules__pnpm_nuxt_643_0_0_rollup_642_79_1_node_modules_nuxt_dist_head_runtime_lib_vueuse_head_plugin_mjs_GwtSCupOCa = defineNuxtPlugin((nuxtApp) => {
  ...
  nuxtApp._useHead = useHead;
  {
    nuxtApp.ssrContext.renderMeta = async () => {
      const { renderSSRHead } = await import('file:///Users/maximehmc/MasteringNuxt/nuxt-3/node_modules/@unhead/ssr/dist/index.mjs');
    ...
    children: [
      {
        ...
        component: () => import('./_nuxt/_lessonSlug_.35a3db95.mjs').then((m) => m.default || m)
      }
    ],
    meta: __nuxt_page_meta$2,
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./_nuxt/course.f149cf71.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index.48fca58f.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.52326404.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { __nuxt_component_0$1 as _, useNuxtApp as a, __nuxt_component_1 as b, _export_sfc as c, entry$1 as default, useRoute as u };
